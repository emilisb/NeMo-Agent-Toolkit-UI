                    ...
                    {!messageIsStreaming && (
                      <>
                        {messagedCopied ? (
                          <IconCheck
                            size={20}
                            className="text-[#f97316] dark:text-[#76b900]"
                            id={message?.id}
                          />
                        ) : (
                          <button
                            className="text-[#f97316] hover:text-gray-700 dark:text-[#76b900] dark:hover:round-gray-300"
                            onClick={copyOnClick}
                        ...
                        <button
                          className="text-[#f97316] hover:text-gray-700 dark:text-[#76b900] dark:hover:text-gray-300"
                        ...
                        {message.observabilityTraceId && (
                          <>
                            <button
                              className={
                                'text-[#f97316] hover:text-gray-700 dark:text-[#76b900] dark:hover:text-gray-300'
                              }
                              onClick={() =>
                                submitFeedback(
                                  message.observabilityTraceId!,
